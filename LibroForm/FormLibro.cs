...
namespace LibroForm
{
    public partial class FormLibro : Form
    {
        ...
        private void SaveLibro()
        {
            ...
            libro.FechaDeEdicion = txtFechaDeEdicion.Text;
        ...
        {//aqui en esta variabl global copio la instancia e contacto para guardarme el ID del contacto
            ...
            if (libro != null)
            {
                ...
                txtFechaDeEdicion.Text = libro.FechaDeEdicion;
            }
        ...
        private bool ValidarDato()
        {
            ...
            if (txtFechaDeEdicion.Text.Trim() == "")
            {
                MessageBox.Show("El dato Fecha de edicion está vacío");
                txtCiudadyPais.Focus();
                datoValido = false;
            }
